                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('fase_followup') is-invalid @enderror"
                                    id="fase_followup"
                                    name="fase_followup">
                                <option value="0" {{ old('fase_followup', 0) == 0 ? 'selected' : '' }}>Fase 0</option>
                                <option value="1" {{ old('fase_followup') == 1 ? 'selected' : '' }}>Fase 1</option>
                                <option value="2" {{ old('fase_followup') == 2 ? 'selected' : '' }}>Fase 2</option>
                                <option value="3" {{ old('fase_followup') == 3 ? 'selected' : '' }}>Fase 3</option>
                            </select>
                            @error('fase_followup')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                   ...
                                   value="{{ old('tgl_next_followup', now()->addDays(3)->format('Y-m-d')) }}">
