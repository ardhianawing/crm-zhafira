...
@section('title', 'Edit Berita - Zhafira CRM')
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">
                <i class="bi bi-pencil" style="color: #0f3d2e;"></i> Edit Berita
            </h4>
                ...
                <form action="{{ route('admin.news.update', $news) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date"
                               ...
                               id="tgl_post"
                               name="tgl_post"
                               value="{{ old('tgl_post', $news->tgl_post->format('Y-m-d')) }}"
                               required>
                        @error('tgl_post')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('isi_berita') is-invalid @enderror"
                                  ...
                                  name="isi_berita"
                                  rows="10"
                                  required>{{ old('isi_berita', $news->isi_berita) }}</textarea>
                        @error('isi_berita')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
